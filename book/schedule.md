...
| [**W8**](lessons/wk8_deep_learning.ipynb) | Deep learning for representations: linear and nonlinear autoencoders (a linear autoencoder is exactly PCA) and a convolutional net on blood-cell images. | Learning a nonlinear latent that follows a curved manifold, and recognizing blood cells with learned convolutional features. | Synthetic manifold fixture · Wisconsin (WDBC) · **BloodMNIST** blood-cell images |
