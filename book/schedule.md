...
| **W8** | Deep learning for representations and dynamics: linear and nonlinear autoencoders (a linear autoencoder is exactly PCA) and shallow sensing-and-reconstruction (SHRED) architectures. Reinforcement learning, transformers, and foundation-model embeddings are taken up in the capstone. | Learning a nonlinear latent that follows a curved manifold, and reconstructing a full spatiotemporal field from a handful of sensors. | Synthetic manifold & field fixtures · Wisconsin (WDBC) |
