...
3. **Ground-truth validation before trusting real data.** Before you believe a
   ...
   a control: here, the PK fit recovering warfarin's **known ~1–2.5-day half-life** and Q-learning recovering the **value-iteration optimum**; more generally a synthetic fixture, a held-out split, or a published benchmark. "It ran without
