...
| `ccle` | CCLE pharmacological profiling (dose–response) | tabular | open | CC BY 4.0 (Broad/DepMap; Zenodo 10.5281/zenodo.3905462) ✓ | direct CSV from data.broadinstitute.org (cached), exploded to per-concentration long form; fallback: synthetic Hill dose–response | wk2 |
