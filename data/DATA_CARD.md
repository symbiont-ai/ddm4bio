...
| `pbmc3k` | 10x PBMC 3k (single-cell RNA-seq) | singlecell | open | Creative Commons / 10x Genomics terms of use [VERIFY] | `scanpy` built-in or 10x `.tar.gz` (cached); fallback: synthetic counts | wk5, wk6, ps5, ps6 |
