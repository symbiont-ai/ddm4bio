...
(`ddm4bio`) plus a full JupyterBook course site: lessons, problem sets, and a
...
book/          JupyterBook course site: lessons, syllabus, schedule, references, capstone + RL preview
