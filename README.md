...
(`ddm4bio`) plus a full JupyterBook course site: weekly lessons, problem sets, and a
warfarin PK/PD capstone.
...
book/          JupyterBook course site: weekly lessons, syllabus, schedule, references, capstone + RL preview
